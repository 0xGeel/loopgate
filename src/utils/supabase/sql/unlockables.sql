...
VALUES ('HTML Blog Example', 'An incredibly exclusive article on token-gating', '0x1337cc354aeaf15b0e98a609cd348df171174e14', 1, 'bafybeiehgpaip4f7jafzf7imgannx3nnv3ubaiwp6ph56mlyzijpqxi45m', 1);

-- Unlockable #2: MP4 Video Example
INSERT INTO unlockables (name, description, owner, content_type_id, content_url, criteria_unlock_amount) 
VALUES ('MP4 Video Example', 'An incredibly exclusive animation', '0x1337cc354aeaf15b0e98a609cd348df171174e14', 1, 'bafybeihx5eacyxeydcpvudwxa242rnjhn67femy46gzas5d2djb24ti5mi', 1);

-- Unlockable #3: Web Game Example
INSERT INTO unlockables (name, description, owner, content_type_id, content_url, criteria_unlock_amount) 
VALUES ('Web Game Example', 'An incredibly exclusive web game', '0x1337cc354aeaf15b0e98a609cd348df171174e14', 1, 'bafybeihhx5v3saq3b7n55ub5q3atuw2udbqc5ictkv2ih7vd3hxptu22nu', 2);